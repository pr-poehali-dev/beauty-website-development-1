...
const services = [
  {
    ...
    items: [
      { name: 'Ботокс для волос', price: '6 000 ₽' },
      { name: 'Кератиновое выпрямление', price: '7 000 ₽' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Голени + колени', price: '1 600 ₽' },
      { name: 'Глубокое бикини', price: '1 800 ₽' },
      { name: 'Ноги полностью', price: '2 500 ₽' },
    ],
  },
  {
    icon: 'Eye',
    ...
    items: [
      { name: 'Наращивание ресниц', price: '2 500 ₽' },
      { name: 'Ламинирование ресниц', price: '2 500 ₽' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Коррекция перманента', price: '6 000 ₽' },
    ],
  },
  {
    icon: 'Flower2',
    ...
    items: [
      { name: 'Классический массаж', price: '3 500 ₽' },
      { name: 'Антицеллюлитный', price: '3 500 ₽' },
      { name: 'Релакс-массаж', price: '3 500 ₽' },
    ],
  },
];
